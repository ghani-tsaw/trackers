...
<?php
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
	  // collect value of input field
		...
		// What if we just save the $url as the last url visited and then compare it in the next page with the ref.
		// if they match that means user is just visiting different pages but if it is different then should do something.



		$sql = "INSERT INTO session_urls (session_id, url_id, stay_duration, exit_scroll_position) VALUES ('$session_id','$url_id', '$stay_duration', '$user_scroll_unload')";
		$conn->query($sql);
